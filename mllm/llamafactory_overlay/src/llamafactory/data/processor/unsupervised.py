...
class UnsupervisedDatasetProcessor(DatasetProcessor):
    def _encode_data_example(
        ...
        messages = self.template.mm_plugin.process_messages(messages, images, videos, audios, skeletons, self.processor)
        ...
        input_ids, _ = self.template.mm_plugin.process_token_ids(
            input_ids, None, images, videos, audios, skeletons, self.tokenizer, self.processor
        )
